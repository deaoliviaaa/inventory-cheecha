            ...
            <div class="shadow-sm sm:rounded-lg p-6 bg-white border border-gray-200">
                <form action="{{ route('supplier-purchases.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="item_name" value="{{ old('item_name') }}" class="w-full border border-gray-300 rounded px-3 py-2 text-gray-800">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="store_name" value="{{ old('store_name') }}" class="w-full border border-gray-300 rounded px-3 py-2 text-gray-800">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="purchase_date" value="{{ old('purchase_date') }}" class="w-full border border-gray-300 rounded px-3 py-2 text-gray-800">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="quantity" value="{{ old('quantity', 1) }}" class="w-full border border-gray-300 rounded px-3 py-2 text-gray-800">
