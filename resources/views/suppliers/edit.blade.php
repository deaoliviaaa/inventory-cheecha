            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6 border border-gray-200">
                <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="kode_supplier" value="{{ old('kode_supplier', $supplier->kode_supplier) }}" class="w-full border rounded px-3 py-2">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_supplier" value="{{ old('nama_supplier', $supplier->nama_supplier) }}" class="w-full border rounded px-3 py-2">
                        @error('nama_supplier') <div class="text-red-600 text-sm">{{ $message }}</div> @enderror
                    </div>

                    <div class="mb-4">
                        <label class="block font-medium mb-1">Address</label>
                        <textarea name="alamat_supplier" class="w-full border rounded px-3 py-2">{{ old('alamat_supplier', $supplier->alamat_supplier) }}</textarea>
                    </div>

                    <div class="mb-4">
                        <label class="block font-medium mb-1">Item Name</label>
                        <input type="text" name="nama_barang" value="{{ old('nama_barang', $supplier->nama_barang) }}" class="w-full border rounded px-3 py-2">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="harga_satuan" value="{{ old('harga_satuan', $supplier->harga_satuan) }}" class="w-full border rounded px-3 py-2" step="0.01">
